...
export function Hero() {
  ...
  useEffect(() => {
    ...
    if (document.fonts && document.fonts.ready) {
      document.fonts.ready.then(setPath);
    }
    return () => window.removeEventListener("resize", setPath);
  }, []);

  return (
    <section className="hero" id="heroStage">
      <div className="hero-inner">
        <div className="hero-copy" id="heroCopy">
          <div className="eyebrow">
            <span className="pill">NEW</span>
            Private beta · built in Bhutan
          </div>
          <h1>
            <span className="line">
              Built for <em>Teams</em>
            </span>
            <span className="line">
              Guided by <em>GNH</em>
            </span>
          ...
          <p>
            Great projects aren&rsquo;t just on time — they&rsquo;re built by people who thrive. Jaggle combines intelligent
            automation with human wellbeing so your team delivers without burning out.
          </p>
          <div className="hero-actions">
            <a className="star-btn star-btn--lg" id="getStartedBtn" href="#cta" ref={btnRef}>
              <span className="star-light" aria-hidden="true" />
              <span className="star-border" aria-hidden="true">
                <svg width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 100 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <defs>
                    <linearGradient id="starbtn_grad" x1="0" y1="0" x2="100" y2="40" gradientUnits="userSpaceOnUse">
                      <stop offset="0" stopColor="#6E8CFF" />
                      <stop offset="1" stopColor="#B080FF" />
                    </linearGradient>
                    <clipPath id="starbtn_clip">
              ...
              <span className="star-content">
                <span className="star-label">Get Jaggle Free</span>
                <i className="ti ti-arrow-right arrow" aria-hidden="true" />
              </span>
            </a>
            <LiquidButton href="/request-demo" size="lg">
              <i className="ti ti-player-play-filled" /> Request Demo
            </LiquidButton>
          </div>
        </div>
      </div>
